...
class VersionTest
  ...
  test("selectNext, table 2") {
    val nextVersions = Table(
      ...
      ("1.2.0+9-4a769501", List("1.2.0+17-7ef9b061"), Some("1.2.0+17-7ef9b061")),
      ("1.2.0+9-4a769501", List("1.2.0+17-7ef91060b"), Some("1.2.0+17-7ef91060b")),
      ("1.2.0+9-4a769501", List("1.2.0+17-7bf9106e"), Some("1.2.0+17-7bf9106e")),
