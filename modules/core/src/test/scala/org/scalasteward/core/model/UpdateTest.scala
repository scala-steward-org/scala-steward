...
class UpdateTest extends FunSuite with Matchers {
  ...
  test("replaceAllIn: updated") {
    ...
    val expected =
      """addSbtPlugin("pl.project13.scala" % "sbt-jmh" % "0.3.3")
        ...
        |addSbtPlugin("org.portable-scala" % "sbt-scalajs-crossproject" % "0.4.0")
      """.stripMargin.trim
    Single("org.scala-js", "sbt-scalajs", "0.6.24", Nel.of("0.6.25"), None)
  ...
  test("replaceAllIn: ignore hyphen") {
    ...
    Single("be.doeraene", "scalajs-jquery", "0.9.3", Nel.of("0.9.4"), None)
      .replaceAllIn(original) shouldBe Some(expected)
  }
  ...
  test("replaceAllIn: ignore '-core' suffix") {
    ...
    Single("org.specs2", "specs2-core", "4.2.0", Nel.of("4.3.4"), None)
      .replaceAllIn(original) shouldBe Some(expected)
  }
  ...
  test("replaceAllIn: use groupId if artifactId is 'core'") {
    ...
    Single("com.softwaremill.sttp", "core", "1.3.2", Nel.of("1.3.3"), None)
      .replaceAllIn(original) shouldBe Some(expected)
  }
  ...
  test("replaceAllIn: version range") {
    ...
    Single("org.specs2", "specs2-core", "3.+", Nel.of("4.3.4"), None)
      .replaceAllIn(original) shouldBe Some(expected)
  }
  ...
  test("replaceAllIn: group with repeated version") {
    ...
    val expected =
      ...
      """.stripMargin.trim
    Group("com.pepegar", Nel.of("hammock-core", "hammock-circe"), "0.8.1", Nel.of("0.8.5"), None)
      .replaceAllIn(original) shouldBe Some(expected)
  }
  ...
  test("replaceAllInStrict") {
    ...
    val expected =
      ...
      """.stripMargin.trim
    Group("org.typelevel", Nel.of("jawn-json4s", "jawn-play"), "0.14.0", Nel.of("0.14.1"), None)
  ...
  test("replaceAllIn: artifactId with dot") {
    ...
    Single("org.webjars.bower", "plotly.js", "1.41.3", Nel.of("1.43.2"), None)
      .replaceAllIn(original) shouldBe Some(expected)
  }
  ...
  test("replaceAllInRelaxed") {
    ...
    Single("io.circe", "circe-generic", "0.9.3", Nel.of("0.11.1"), None)
  ...
  test("replaceAllInRelaxed: camel case artifactId") {
    ...
    Single("com.zaxxer", "HikariCP", "3.3.0", Nel.of("3.4.0"), None)
      .replaceAllInRelaxed(original) shouldBe Some(expected)
  }
  ...
  test("group: 1 update") {
    val updates = List(Single("org.specs2", "specs2-core", "3.9.4", Nel.of("3.9.5"), None))
    Update.group(updates) shouldBe updates
  }

  test("group: 2 updates") {
    val update0 = Single("org.specs2", "specs2-core", "3.9.4", Nel.of("3.9.5"), None)
  ...
  test("group: 2 updates with different configurations") {
    ...
    Update.group(List(update0, update1)) shouldBe List(
      Single("org.specs2", "specs2-core", "3.9.4", Nel.of("3.9.5"), None)
    )
  }
  ...
  test("Single.show") {
    val update = Single("org.specs2", "specs2-core", "3.9.4", Nel.of("3.9.5"), None, Some("test"))
