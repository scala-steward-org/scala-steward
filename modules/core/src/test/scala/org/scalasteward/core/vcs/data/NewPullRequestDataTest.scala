  ...
  test("asJson") {
    ...
    NewPullRequestData
      ...
      """|{
         ...
         |  "body" : "Updates ch.qos.logback:logback-classic from 1.2.0 to 1.2.3.\n\n\nI'll automatically update this PR to resolve conflicts as long as you don't change it yourself.\n\nIf you'd like to skip this version, you can just close this PR. If you have any feedback, just mention me in the comments below.\n\nHave a fantastic day writing Scala!\n\n<details>\n<summary>Configure `scala-steward` for your repository by adding [.scala-steward.conf](https://github.com/fthomas/scala-steward/blob/master/docs/repo-specific-configuration.md)</summary>\n\nAdd this to your `.scala-steward.conf` file to ignore future updates of this dependency:\n```\nupdates.ignore = [ { groupId = \"ch.qos.logback\", artifactId = \"logback-classic\" } ]\n```\nAdd this to your `.scala-steward.conf` file to make `scala-steward` create PRs only once a week:\n```\npullRequests.frequency = \"@weekly\"\n```\n</details>\n\nlabels: library-update, semver-patch",
