...
# pullRequests.branchPrefix allows you to customize the prefix Scala Steward uses
# for update branch names. For example, a prefix of "scala-steward" creates branch
# names like "scala-steward/cats-effect-3.4.0".
# Default: "update"
